    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          That study page doesn't exist. Head back and keep learning.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AI Study Buddy — Learn C, Python, Maths & AI/ML" },
      {
        name: "description",
        content:
          "AI Study Buddy gives every learner their own account with an AI tutor, quizzes, flashcards, timetable and progress tracking.",
      },
      { property: "og:title", content: "AI Study Buddy" },
      { property: "og:description", content: "Your personal AI tutor for C, Python, Maths and AI/ML." },
